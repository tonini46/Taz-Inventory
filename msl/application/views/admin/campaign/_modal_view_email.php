                          ...
                          <tbody>
                            ...
                            <tr>
                              <td><table border="0" cellspacing="0" cellpadding="0" style="font-family:Helvetica,Arial,sans-serif" width="100%">
                                  <tbody>
                                    <tr>
                                      <td align="left" valign="middle" width="95" height="21"><a style="http://www.measurementsystems.co.ke"><img src="/asset/img/logo_theme.png" height="61" alt="Measurement Systems Ltd" style="border:none;text-decoration:none" class="CToWUd"></a></td>
                                    </tr>
                                  </tbody>
                                </table></td>
                            </tr>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td align="center"><table border="0" cellspacing="0" cellpadding="0" style="color:#999999;font-size:11px;font-family:Helvetica,Arial,sans-serif" width="100%">
                                  <tbody>
                                    <tr>
                                      <td align="center" dir="ltr">Copyright '.date('Y').' <a href="https://www.measurementsystems.co.ke/">'.$company_name.'</a>. All rights reserved.</td>
                                    </tr>
                                    <tr>
                                      <td><table width="1" border="0" cellspacing="0" cellpadding="0" style="font-family:Helvetica,Arial,sans-serif">
                                          <tbody>
