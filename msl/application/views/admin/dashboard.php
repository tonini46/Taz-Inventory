                    ...
                    <div class="col-md-2 col-sm-4">
                        <div class="pad box-pane-right bg-green" style="min-height: 280px">
                            <div class="description-block margin-bottom">
                                ...
                                <h5 class="description-header"><?php echo $currency .' '. number_format(currency($total->selling_price - $total->buying_price - $discount->discount_amount ,2))  ?></h5>
                                <span class="description-text">TOTAL REVENUE</span>
                            </div><!-- /.description-block -->
                            <div class="description-block margin-bottom">
                                <div class="sparkbar pad" data-color="#fff"><canvas height="30" width="34" style="display: inline-block; width: 34px; height: 30px; vertical-align: top;"></canvas></div>
                                <h5 class="description-header"><?php echo $currency .' '. number_format(currency($total->buying_price , 2))  ?></h5>
                                <span class="description-text">TOTAL SALES</span>
                            </div><!-- /.description-block -->
                            <div class="description-block">
                                <div class="sparkbar pad" data-color="#fff"><canvas height="30" width="34" style="display: inline-block; width: 34px; height: 30px; vertical-align: top;"></canvas></div>
                                <h5 class="description-header"><?php echo $currency .' '. number_format(currency($total_expense->expense_amount , 2))  ?></h5>
                                <span class="description-text">TOTAL EXPENSES</span>
                            </div><!-- /.description-block -->
                            <div class="description-block">
                                <div class="sparkbar pad" data-color="#fff"><canvas height="30" width="34" style="display: inline-block; width: 34px; height: 30px; vertical-align: top;"></canvas></div>
                                <h5 class="description-header"><?php echo $currency .' '. number_format(currency($total->product_tax , 2))  ?></h5>
...
<div class="row">
    <div class="col-md-8">
                    ...
                    <table class="table no-margin">
                        ...
                        <?php if($order_info): foreach($order_info as $v_order): ?>
                            <tr>
                                ...
                                <td><?php echo $currency .' '. number_format(currency($v_order->grand_total , 2))  ?></td>
                            </tr>
                        <?php endforeach;
                        else:?>
        ...
        <div class="box">
                ...
                <div class="table-responsive">
                    <table class="table no-margin">
                        ...
                        <?php if($activity_info): foreach($activity_info as $v_activity): ?>
                            <tr>
                                <td><?php echo $v_activity->activityTitle ?></a></td>
                                <td><?php echo $v_activity->activityDate ?></td>
                                <td><?php echo country($v_activity->country_id) ?></td>
                            </tr>
                        <?php endforeach;
                        else:?>
            ...
            <div class="box-footer clearfix">
                <a href="<?php echo base_url() ?>admin/activity/activity_logs" class="btn btn-sm bg-purple btn-flat pull-right">View All Activities</a>
            </div><!-- /.box-footer -->
        </div><!-- /.box -->
<?php } ?>
    </div><!-- /.col -->
                           ...
                           <div class="product-info">
                               <a href="<?php echo base_url() ?>admin/product/manage_product"
                                  class="product-title">Barcode:<?php echo $v_product->product_code ?><span
                                       class="label label-warning pull-right"><?php echo $currency.' '.currency($v_product->selling_price) ?></span></a>
                            ...
                            "<?php
                                if (!empty($v_result)) {
                                    ...
                                    foreach($v_result as $result){
                                        ...
                                        echo round(currency($result->grand_total));
                                    }
                                }
                                ?>",
                        <?php endforeach; ?>
