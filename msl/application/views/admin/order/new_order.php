                ...
                <div class="row">
                            ...
                            <div class="box-body order-panel">
                                ...
                                <div id="my-tab-content" class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="product-list">
                                        ...
                                        <br/>
                                        <div id="cart_content">
                                            <?php $this->load->view('admin/order/cart/cart.php'); ?>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="search-product">
                                        ...
                                        //User
                                            ...
                                            //Create a Variable from a string
                                            $field = '$'.'v_product->product_quantity_'.country($this->session->userdata('user_country'));
                                            eval("\$field = \"$field\";");
                                            //echo $field;
                    ...
                    <div class="col-md-5 col-sm-12">
                            ...
                            <div class="box">
                                ...
                                <div id="cart_summary">
                                    <?php $this->load->view('admin/order/cart/cart_summary.php') ?>
                                </div>
