...
<span>TAX ID : </span>0427544R
    ...
    <table class="table table-bordered">
      <thead>
        <tr>
          <td style="width: 50%;"><b>SOLD TO</b></td>
          <td style="width: 50%;"  class="text-right"><b>RECIEPT DETAILS</b></td>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td class="text-right zigi">
            <span>RECIEPT NO.: </span><?php echo $order_info->order_no ?><br>
    ...
    <table class="table table-bordered" style="text-align:center;">
      ...
      <tbody>  
        <tr>
          ...
          <td><?php echo $order_info->payment_ref; ?></td>
