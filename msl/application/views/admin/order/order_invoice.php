        ...
        <div class="box-tools pull-right">
            ...
            <div class="box-tools">
                <div class="btn-group" role="group" >
                    <a href="<?php echo base_url() ?>admin/order/pdf_receipt/<?php echo $invoice_info->invoice_no ?>" class="btn btn-danger "><i class="fa fa-download"></i> Reciept PDF</a>
                </div>
                <div class="btn-group" role="group" >
                    <a href="<?php echo base_url() ?>admin/order/pdf_invoice/<?php echo $invoice_info->invoice_no ?>" class="btn btn-warning "><i class="fa fa-download"></i> Invoice PDF</a>
                </div>
                <div class="btn-group" role="group" >
                    ...
                    ?>><i class="fa fa-envelope"></i> Email Invoice to Customer</a>
                </div>
            </div>
