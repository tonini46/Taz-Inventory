        ...
        <div class="box-tools pull-right">
            ...
            <div class="box-tools">
                <div class="btn-group" role="group" >
                    ...
                    <a href="<?php echo base_url() ?>admin/purchase/pdf_invoice/<?php echo $purchase->purchase_id ?>" class="btn btn-danger hidden"><i class="fa fa-download"></i> PDF</a>
                </div>
            </div>
                ...
                <main >
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td class="unit"><?php echo number_format(currency($v_product->unit_price, 2)); ?></td>
                            <td class="qty"><?php echo $v_product->qty ?></td>
                            <td class="total"><?php echo number_format(currency($v_product->sub_total,2)) ?></td>
                        </tr>
                            <?php $counter ++?>
                        <?php endforeach; ?>
                        </tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $currency.' '.number_format(currency($purchase->grand_total,2)) ?></td>
                        </tr>
                        <tr>
