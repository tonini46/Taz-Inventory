<?php $base_url = 'http://127.0.0.1:55055/'; ?>
                    ...
                    <div class="row">
                                ...
                                <div class="box-body">
                                    ...
                                    <div id="my-tab-content" class="tab-content">
                                        ...
                                        <div class="tab-pane" id="add-product">
                                            <div class="panel" style="background:rgba(255, 0, 0, 0.12); font-size:11px; padding:5px 10px;"><i class="fa fa-warning text-danger"></i> New products only. After purchase go to <b>Product > Add Product</b> and add the product</div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="box box-info">
                                ...
                                <!-- Table -->
                                <div id="cart_content">
                                    <?php $this->load->view('admin/purchase/cart/cart.php'); ?>
                                </div>
