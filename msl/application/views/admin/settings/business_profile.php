                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3">
                            ...
                            <div class="box-body">
                                ...
                                <!-- /.Forex -->
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Forex Exchange<span class="required">*</span></label>
                                    <small style="font-size:10px; color:maroon;"> ( If <b>Local</b> please Update <b>Manage Forex</b> Page )</small>
                                    <div class="form-control col-sm-5" style="border:none;">
                                    <label class="radio-inline"><input type="radio" name="forex" value="0" <?php
                                           if ($business_info->forex == 0) {
                                               echo 'checked';
                                           }
                                           ?>>Local</label>
                                    <label class="radio-inline"><input type="radio" name="forex" value="1"<?php
                                           if ($business_info->forex == 1) {
                                               echo 'checked';
                                           }
                                           ?>>Online</label>
                                  </div>
