                                ...
                                <div class="tab-pane" id="inventory">
                                    ...
                                    <div class="box">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label>Product Quantity - <?php echo $key->name; ?></label>
                                                <input type="text" id="product_quantity_<?php echo $key->name; ?>" name="product_quantity_<?php echo $key->name; ?>" placeholder="Quantity"
                                                       value="<?php
                                                       if (!empty($inventory)) {
                                                        //Create a Variable from a string
                                                        $field = '$'.'inventory->product_quantity_'.$key->name;
                                                        eval("\$field = \"$field\";");
                                                        echo $field;
                                                       }
                                                       ?>"
...
$().ready(function() {
    $("#addProductForm").validate({
        ...
        rules: {
            ...
            <?php 
            foreach ($country as $key) {?>
            product_quantity_<?php echo $key->name; ?>: {
                required: true,
                number:true
