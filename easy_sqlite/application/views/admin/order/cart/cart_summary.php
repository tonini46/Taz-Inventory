                    ...
                    <div class="col-md-12">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                if(empty($cart)){
                                    echo '0.00';
                                }else{ echo $this->cart->format_number(currency($this->cart->total()));  }
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                if(empty($cart)){
                                    ...
                                    echo number_format(currency($total_tax, 2, '.', ',')) ;
                                }
                                ?>" disabled class="form-control unite">
                            </div>
                        </div>
                    ...
                    <?php if(!empty($discount)): ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                ?>
                                <input type="text" value="<?php echo number_format(currency($discount_amount, 2, '.', ',')) ;
                                ?>" disabled class="form-control unite">
                            </div>
                        </div>
                    <?php endif ?>
                        ...
                        <div class="col-sm-7">
                            <h1><?php
                                if(empty($cart)){
                                    ...
                                    echo $currency.' '.number_format(currency($grand_total , 2, '.', ',')) ;
                                }
                                ?></h1>
                        </div>
                    </div>
