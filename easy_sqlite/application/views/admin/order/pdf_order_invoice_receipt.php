...
<td><td style="text-align:right;"><h1 style="padding:0; margin:0;">Sales Reciept #<?php echo $invoice_info->invoice_no; ?></h1></td></tr></table>
<div style="position:relative; height:160px; width:100%;">
<img src="http://localhost/mea_syst_new/image/catalog/1.png" alt="Measurement Systems Ltd." class="img-thumbnail" style="position:absolute; left:0; top:0;" width="60%"/>
      ...
      <tbody>
        <tr>
          <td style="width: 50%;">
            ...
            <span>Website</span> <a href="http://www.measurementsystems.co.ke">http://www.measurementsystems.co.ke</a></td>
          <td style="width: 50%;"><span>Date of Invoice:</span> <?php echo date('Y-m-d', strtotime($invoice_info->invoice_date )) ?><br />
            <?php if ($invoice_info->invoice_no) { ?>
            <span>Invoice No.</span> <?php echo $invoice_info->invoice_no; ?><br />
            <?php } ?>
            <span>Order ID:</span> <?php echo 'sss'; ?><br />
            <span>Payment Method</span> <?php echo 'sss'; ?><br />
            <?php if ($order_info->sales_person) { ?>
            <span>Sales Person:</span> <?php echo $order_info->sales_person ?><br />
            <?php } ?></td>
        </tr>
      </tbody>
    </table>
