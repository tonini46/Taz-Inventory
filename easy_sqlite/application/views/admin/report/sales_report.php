                            ...
                            <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <?php if (!empty($order_details)): foreach ($order_details as $v_order) : ?>
                                        ...
                                        <?php if($order[$key]->discount_amount !=0): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $currency.' '.number_format(currency($order[$key]->discount_amount,2)) ?></td>
                                            </tr>
                                        <?php endif; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $currency.' '.number_format(currency($order[$key]->grand_total ,2)) ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4"></td>
                                            <td colspan="2">Profit</td>
                                            <td><?php echo $currency.' '.number_format( currency($order[$key]->grand_total - $total_buying_price,2)) ?></td>
                                        </tr>
                                        </tfoot>
                                        <?php
                                ...
                                <?php endforeach; endif; ?>
                                    ...
                                    <table>
                                        ...
                                        <td class="total"><?php echo  $currency.' '.number_format( currency($total_cost,2)) ?></td>
                                        <td class="total"><?php echo $currency.' '.number_format( currency($total_sell,2)) ?></td>
                                        <td class="total"><?php echo $currency.' '.number_format( currency($total_profit,2)) ?></td>
                                        </tbody>
                                    </table>
