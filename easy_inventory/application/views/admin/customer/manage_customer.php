                        ...
                        <table class="table table-bordered table-striped" id="dataTables-example">
                            ...
                            <?php if (!empty($customer)): foreach ($customer as $v_customer) : ?>
                                <tr class="custom-tr">
                                    ...
                                    <td class="vertical-td"><?php echo country($v_customer->country_id) ?></td>
                                    <td class="vertical-td"><?php echo $v_customer->discount ?> %</td>

                                    <td class="vertical-td">
                                        <?php echo btn_pdf('admin/customer/pdf_customer/' . $v_customer->customer_id); ?>
                                        <?php echo btn_email('admin/customer/email_customer/' . $v_customer->customer_id); ?>
