...
<!--                <input  type="text" name="price" value="--><?php //echo $item['price'] ?><!--"  onblur ="order(this);" id="--><?php //echo 'pri'.$item['rowid'] ?><!--" class="form-control">-->
                <div class="input-group">
                    ...
                    <input  type="text" name="price" value="<?php echo currency($item['price']) ?>"  onblur ="order(this);" id="<?php echo 'pri'.$item['rowid'] ?>" class="form-control"
            ...
            <td class="vertical-td"><?php echo number_format(currency($item['subtotal'], 2, '.', ','))  ?></td>
