        ...
        <div class="col-sm-6 col-md-8">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class=""><?php echo $currency.' '.currency($product->buying_price) ?></td>
                </tr>
                <tr>
                    <td class="col-sm-3">Selling Price</td>
                    <td><?php echo $currency.' '.currency($product->selling_price) ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><?php echo $currency.' '.currency($product->offer_price) ?></td>
                </tr>
                ...
                <tr>
                    <td class="no-border" colspan="2">
                        ...
                        <table class="table table-bordered nowrap">
                            ...
                            <tr>
                                <td><?php echo $currency.' '.currency($v_tier_price->quantity_above) ?></td>
                                <td><?php echo $currency.' '.currency($v_tier_price->tier_price) ?></td>
                            </tr>
                            <?php } ?>
                            </tbody>
                        </table>
