	...
	{{ Form::open(array('url' => 'client', 'role' => 'form', 'class' => 'solsoForm')) }}
		...
		<div class="col-md-6 col-lg-3">
			...
			<div class="form-group">
				...
				<input type="text" name="country" class="form-control required" autocomplete="off" value="{{ Input::old('country') }}">
			...
			<div class="form-group">
				...
				<input type="text" name="state" class="form-control required" autocomplete="off" value="{{ Input::old('state') }}">
			...
			<div class="form-group">
				...
				<input type="text" name="city" class="form-control required" autocomplete="off" value="{{ Input::old('city') }}">
			...
			<div class="form-group">
				...
				<input type="text" name="zip" class="form-control required" autocomplete="off" value="{{ Input::old('zip') }}">
			...
			<div class="form-group">
				...
				<input type="text" name="address" class="form-control required" autocomplete="off" value="{{ Input::old('address') }}">
		...
		<div class="col-md-6 col-lg-3">		
			<div class="form-group">
				...
				<input type="text" name="contact" class="form-control required" autocomplete="off" value="{{ Input::old('contact') }}">
			...
			<div class="form-group">
				...
				<input type="text" name="phone" class="form-control required" autocomplete="off" value="{{ Input::old('phone') }}">
			...
			<div class="form-group">
				...
				<input type="url" name="website" class="form-control" autocomplete="off" value="{{ Input::old('website') }}">
			...
			<div class="form-group">
				...
				<input type="text" name="bank" class="form-control" autocomplete="off" value="{{ Input::old('bank') }}">
			</div>	

			<div class="form-group">
				<label for="bank_account"> {{ trans('invoice.bank_account') }} </label>
				<input type="text" name="bank_account" class="form-control" autocomplete="off" value="{{ Input::old('bank_account') }}">
			</div>				
		</div>
